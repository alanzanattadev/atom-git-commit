...
describe "GitCommit", ->
  ...
  beforeEach ->
    ...
    activationPromise = atom.packages.activatePackage('git-commit')

  describe "when the git-commit:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'git-commit:toggle'
        expect(gitCommitPanel.isVisible()).toBe false
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'git-commit:toggle'
        expect(gitCommitElement).not.toBeVisible()
